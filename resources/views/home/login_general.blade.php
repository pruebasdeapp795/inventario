...
<head>
    ...
    <title>Login - Usuarios Generales</title>
        ...
        <div class="login-card">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="text-start">
                    ...
                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="Ej. admin_01" value="{{ old('username') }}" required>
                    @error('username')
